...
class ReviewsTest < ApplicationSystemTestCase
  ...
  test "creating a Review" do
    ...
    fill_in "Diffculty", with: @review.diffculty
    fill_in "Studytime", with: @review.studyTime
    fill_in "Timewish", with: @review.timeWish
    fill_in "Worktime", with: @review.workTime
